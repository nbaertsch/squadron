...
NOTE: These tests are skipped until issue #63 is fixed. They document
the expected behavior but cannot pass against the current implementation.
"""
...
# Skip all tests in this module until issue #63 is fixed
pytestmark = pytest.mark.skip(reason="Issue #63 not yet implemented")
...
class TestFeatDevCleanupWorkflow:
    ...
    async def test_manual_report_complete_posts_comment_but_lacks_pm_mention(self, registry):
        ...
        await tools.report_complete(agent_id, params)
